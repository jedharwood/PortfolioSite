...
export const metadata = {
    ...
    description:
        'Explore Jed Harwood’s professional journey; from early roles to recent developer positions — including detailed responsibilities, achievements and tech stacks.',
};
